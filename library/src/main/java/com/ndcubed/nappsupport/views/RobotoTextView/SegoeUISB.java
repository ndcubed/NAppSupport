...
public class SegoeUISB extends TextView {

    public SegoeUISB(Context context) {
        super(context);    //To change body of overridden methods use File | Settings | File Templates.
        createFont();
    }

    public SegoeUISB(Context context, AttributeSet attrs) {
        super(context, attrs);    //To change body of overridden methods use File | Settings | File Templates.
        createFont();
    }

    public SegoeUISB(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void createFont() {
        if(!isInEditMode()) {
            Typeface font = Typeface.createFromAsset(getContext().getAssets(), "seguisb.ttf");
            setTypeface(font);
        }
    }
}
